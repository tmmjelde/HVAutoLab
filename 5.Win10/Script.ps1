...
#Remove useless windows apps
$AllApps = Get-AppxProvisionedPackage -Online
$AllApps | select-object DisplayName | sort DisplayName
$AppsToRemove = @(
...
if ($env:computername -ne $config.computername){
    ...
    Set-ItemProperty $RegPath "DefaultUsername" -Value "Admin" -type String 
