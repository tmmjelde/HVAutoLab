...
$UnattendLocation = "$mypath\WS2016"
$VMName = "WS20162.$($Config.DomainName)"
...
function new-labvm ($vm){
  ...
  Set-VMDvdDrive -VMName $vm -ControllerLocation 0 -Path "D:\Source\Windows Server 2016\Windows_Server_2016_Datacenter_EVAL_en-us_14393_refresh.ISO"
